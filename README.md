...
- **Команды владельца:** `/post`, `/postlink`, `/status`, `/usage`, `/on`, `/off`, `/chatid`.
...
Запустите файл [start.bat](file:///c:/Users/alevo/Desktop/dump assistant bot/start.bat) в корневой папке проекта. Он автоматически откроет консоли и запустит:
